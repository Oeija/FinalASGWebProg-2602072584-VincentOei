...
<div class="container mt-4">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item"><strong>@lang('lang.hobbies'): </strong>{{ implode(', ', json_decode(Auth::user()->hobbies, true)) }}</li>
                <li class="list-group-item"><strong>Instagram: </strong><a href="https://www.instagram.com/{{ Auth::user()->instagram_username }}" target="_blank" rel="noopener noreferrer">{{ Auth::user()->instagram_username }}</a></li>
            </ul>
        </div>
        @if(session('error'))
    ...
    <div class="text-center">
        <a href="{{ route('marketPage') }}" class="btn btn-primary">@lang('lang.buy_new_avatar')</a>
    </div>
</div>
<script>
